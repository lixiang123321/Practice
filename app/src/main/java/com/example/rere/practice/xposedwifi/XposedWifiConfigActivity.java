...
public class XposedWifiConfigActivity extends BaseActivity {
    ...
    public static void start(Context context) {
        context.startActivity(new Intent(context, XposedWifiConfigActivity.class));
    }
...
//        String format = "yyyyMMddHHmmss";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_xposed_wifi_config);
        assignViews();
    }

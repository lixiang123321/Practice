...
/**
 * Created by rere on 2018/6/18.
 */

public class XposedWifiActivity extends TestBaseActivity {

    public static void start(Context context) {
        context.startActivity(new Intent(context, XposedWifiActivity.class));
    }
    ...
    protected void addViews(LinearLayout layout) {
        ...
        getButton(layout, "jump to wifi config", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // jump to wifi config
                XposedWifiConfigActivity.start(mContext);
            }
        });
    ...
    private void scanWifisWifiPermissionCheck() {
        ...
        for (String permission : permissions) {
            if (ContextCompat.checkSelfPermission(mContext, permission)
                ...
                ActivityCompat.requestPermissions(XposedWifiActivity.this,
                        permissions,
